...
<div class="three-col">
    ...
    function doLogin()
    {
        ...
        openModal("login.aspx?Redirect=AddEvent&Details=" + form.<%=what.ClientID %>.value);
    }
    function doAddEvent()
    {
        var form = document.forms[0];
        openModal("addEvent.aspx?Name=" + form.<%=what.ClientID %>.value);
    }
    ...
    {
        var form = document.forms[0];
        form.<%=what.ClientID %>.value = "";
    }
    function clearWhat2()
    {
        var form = document.forms[0];
        form.<%=what2.ClientID %>.value = "";
    }
    </script>
        ...
        <tr>
            <td><h3 class="blue"><asp:HyperLink ID="addLink" runat="server" Text="Add goal" /></h3>
                ...
                <asp:Panel ID="Panel1" DefaultButton="" runat="server">
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td valign="top"><asp:TextBox ID="what" runat="server" CssClass="what"
            ...
            <td><h3 class="blue"><asp:LinkButton ID="findButton" runat="server" Text="Find people" OnClick="searchButton2_click" /></h3>
                ...
                <asp:Panel ID="Panel2" DefaultButton="searchButton2" runat="server">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td valign="top"><asp:TextBox ID="what2" runat="server" MaxLength="1000"  CssClass="what"
