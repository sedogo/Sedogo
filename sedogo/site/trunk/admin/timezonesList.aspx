<%@ Page Language="C#" MasterPageFile="~/admin/AdminMaster.master" AutoEventWireup="true" 
    CodeFile="timezonesList.aspx.cs" Inherits="admin_timezonesList" Theme="AdminTheme" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="GridContainerHeader"><span>Timezones</span></div>
    ...
    <ComponentArt:Grid
        ...
        Width="900"
        Height="500"
        EmptyGridText="&nbsp;<br/>There are no timezones<br/>&nbsp;"
        runat="server" 
        OnSelectCommand="onRowSelect">
        <Levels>
            <ComponentArt:GridLevel
                AllowGrouping="false"
                DataKeyField="TimezoneID"
                ...
                >
                <Columns>
                    <ComponentArt:GridColumn DataField="ShortCode" HeadingText="Code" />
                    <ComponentArt:GridColumn DataField="Description" HeadingText="Description" />
                    <ComponentArt:GridColumn DataField="GMTOffset" HeadingText="Offset" />
                        
                    <ComponentArt:GridColumn DataField="TimezoneID" Visible="false" />
                </Columns>
            </ComponentArt:GridLevel>
        </Levels>
            ...
            <ComponentArt:ClientTemplate Id="SliderTemplate">
                ...
                <tr>
                  <td style="padding:10px;" valign="center" align="center">
                    Page <b>## DataItem.PageIndex + 1 ##</b> of <b>## timezoneListGrid.PageCount ##</b>
                  </td>
                </tr>
                </table>
            </ComponentArt:ClientTemplate>
    ...
    <div class="ButtonsContainer">
        ...
        <div class="FooterButton">
            <asp:HyperLink ID="addTimezoneLink" NavigateUrl="~/admin/addTimezone.aspx" runat="server" 
                Text="Add timezone" />
        </div>
        <div class="FooterButton">
