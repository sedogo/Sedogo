<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewEvent.aspx.cs" Inherits="viewEvent"
    EnableEventValidation="false" ValidateRequest="false" MasterPageFile="Main.master" %>
            ...
            <tr>
                <td width="485px">
                    <div style="float: right; margin: 5px 5px">
                        <asp:Image ID="privateIcon" runat="server" ImageUrl="~/images/private.gif" Visible="false" /></div>
                            ...
                            <tr>
                                <td>
                                    <asp:DataList ID="dlImages" runat="server" RepeatColumns="12" RepeatDirection="Horizontal"
                                        ...
                                        <ItemTemplate>
                                            <div>
                                                <a href="morePictures.aspx?EID=<%# DataBinder.Eval(Container.DataItem, "EventID") %>">
                                                    <img src="assets/eventPics/<%# DataBinder.Eval(Container.DataItem, "ImageThumbnail") %>"
                                ...
                                <td>
                                    <img src="images/1x1trans.gif" width="15px" height="1" />
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div id="loginRegisterPanel" runat="server" style="border: solid 1px #CCCCCC; width: 485px;
                        ...
                        <p>
                            ...
                            <asp:HyperLink ID="loginLink" NavigateUrl="~/login.aspx" runat="server" Text="Click here to login"
                                CssClass="modal" /><br />
                            or
                            <asp:HyperLink ID="registerLink" NavigateUrl="~/register.aspx" runat="server" Text="click here to register" />
                ...
                <td width="200px">
                    <div style="width: 200px; padding-top: 10px; overflow: hidden">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                ...
                                <td align="right">
                                    <asp:LinkButton ID="morePicturesButton" runat="server" OnClick="morePicturesButton_click"
                                        Text="More pictures" CssClass="underline-bold" />
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <div id="eventLinksDiv" runat="server">
                            <div id="invitesBox" runat="server">
                                ...
                                <p>
                                    ...
                                    &nbsp;&nbsp;<asp:LinkButton ID="invitesLink" runat="server" OnClick="click_inviteUsersLink"
                                        Text="Invite more" CssClass="underline-bold" /><br />
                                    &nbsp;</p>
                            </div>
                        </div>
                    ...
                    <div id="eventLinksDiv2" runat="server">
                        ...
                        <table border="0" cellspacing="0" cellpadding="2">
                            <tr>
                                <td>
                                    <asp:Image ID="messageTrackingImage" runat="server" ImageUrl="./images/greyEnv.gif" />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                                <td>
                                    <asp:HyperLink ID="messageTrackingUsersLink" runat="server" Text="Message All" NavigateUrl="javascript:messageTrackingUsers();" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="0" cellspacing="0" cellpadding="2">
                            <tr>
                                <td>
                                    <asp:Image ID="followersTrackingImage" runat="server" ImageUrl="./images/messages.gif" />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                                <td>
                                    <asp:HyperLink ID="followersTrackingUsersLink" runat="server" Text="Message All"
